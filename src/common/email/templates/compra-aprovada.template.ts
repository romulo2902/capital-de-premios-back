export interface CompraAprovadaParams {
  nomeCliente: string;
...
export function compraAprovadaTemplate(p: CompraAprovadaParams): string {
        ...
        <tr>
          <td style="background-color:#1e4470;background:linear-gradient(135deg,#1a3a5c 0%,#295280 50%,#2d5c8f 100%);padding:36px 32px 28px;border-radius:20px 20px 0 0;">
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="margin-bottom:18px;">
              <tr>
                <td align="center" valign="middle"
                    style="width:64px;height:64px;background-color:#436F3A;border-radius:50%;text-align:center;vertical-align:middle;font-size:32px;color:#ffffff;font-weight:900;line-height:64px;padding:0;">
                  &#10003;
                </td>
              </tr>
            </table>
            ...
            <div style="font-size:14px;color:#a8c4e0;font-weight:500;">
              Voc&ecirc; j&aacute; est&aacute; concorrendo
            </div>
        ...
        <tr>
          <td style="padding:28px 32px 32px;background-color:#ffffff;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:24px;">
              <tr>
                <td style="border-left:3px solid #436F3A;padding:4px 0 4px 14px;font-size:15px;color:#374151;line-height:1.6;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0"
              ...
              <tr>
                ...
                <td align="right" style="padding:11px 20px;border-top:1px solid #E2E8F0;font-size:16px;font-weight:700;color:#436F3A;">
                  ${p.valorFormatado}
                </td>
              </tr>
              ...
              <tr>
                ...
                <td align="right" style="padding:11px 20px 18px;border-top:1px solid #E2E8F0;">
                  <span style="display:inline-block;background-color:#eaf2e8;color:#2a4a24;font-size:12px;font-weight:700;padding:4px 12px;border-radius:100px;border:1px solid #b5d4ae;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0"
              ...
              <tr>
                ...
                <td style="padding:14px 16px 14px 6px;font-size:13px;font-weight:600;color:#92400E;line-height:1.5;vertical-align:middle;">
                  Te desejamos muita sorte! Que essa seja a sua vez de ganhar.
                </td>
              </tr>
            </table>
