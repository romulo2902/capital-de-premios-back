...
export function setupOpenApiDocs(
  ...
  const posDocument = buildAudienceDocument(
    ...
    [
      ...
      '4. POST /api/pos/vendas                                   — Criar venda Prêmios + gerar cobrança',
      '5. GET  /api/pos/vendas/:id/pagamento                     — Consultar status Prêmios',
      '6. GET  /api/pos/capital-sena/edicoes                     — Edições ativas Sena',
      '7. POST /api/pos/capital-sena/vendas                      — Criar venda Sena + gerar cobrança',
      '8. GET  /api/pos/capital-sena/vendas/:id/pagamento        — Consultar status Sena',
      '```',
      '',
      '### Autenticação',
